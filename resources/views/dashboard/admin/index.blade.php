        ...
        <div class="card card-xl-stretch mb-xl-8">
          ...
          <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar">
              ...
              <a href="/dashboard/users" class="btn btn-sm btn-light-primary">
                <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                <span class="svg-icon svg-icon-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                    <path d="M12 3C4.5885 3 3 4.5885 3 12C3 19.4115 4.5885 21 12 21C19.4115 21 21 19.4115 21 12" stroke="#009ef7" stroke-width="2" stroke-linecap="round" />
              ...
              <table class="table align-middle gs-0 gy-4" id="myTable">
                ...
                <thead>
                  <tr class="fw-bolder text-muted bg-light">
                    <th scope="row" class="ps-4 min-w-25px rounded-start">No</th>
                ...
                <tbody>
                  ...
                  <tr id="data">
                    ...
                    <td>
                      <a class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{$admin->name}}</a>
                    </td>
                    <td>
                      <a class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{$admin->nomor_induk}}</a>
                    </td>
                    <td>
                      <a class="text-dark fw-aolder text-hover-primary d-block mb-1 fs-6">{{$admin->email}}</a>
                    </td>
                    <td>
