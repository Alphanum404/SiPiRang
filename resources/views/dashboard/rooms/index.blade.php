...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
  ...
  <div class="col-md-16 mx-auto alert alert-success text-center alert-dismissible fade show" style="margin-top: 50px"
    role="alert">
    {{session('deleteRoom')}}
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>
@endif
    <div class="card mb-5 mb-xl-8">
      <div class="card card-xl-stretch mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
          ...
          <div class="column card-toolbar">
            <input type="text" id="myInput" class="form-control" style="width: 100px; height: 37px" placeholder="Search"
              onkeyup="filterTable()" />
            @if (auth()->user()->role_id <= 4) <button class="btn btn-sm btn-light-primary" type="button"
          data-bs-toggle="modal" data-bs-target="#pinjamRuangan">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M20.5 3.5L15 9" stroke="#323232" stroke-width="2" stroke-linecap="round"
            stroke-linejoin="round" />
            <path d="M16 3H20.6717C20.853 3 21 3.14703 21 3.32837V8" stroke="#323232" stroke-width="2"
      ...
      @endif
            @if (auth()->user()->role_id <= 2) <button class="btn btn-sm btn-light-success" data-bs-toggle="modal"
          data-bs-target="#addRoom">
          <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
          <span class="svg-icon svg-icon-2">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <rect opacity="0.5" x="11.364" y="20.364" width="16" height="2" rx="1"
            transform="rotate(-90 11.364 20.364)" fill="red"></rect>
      ...
      @endif
        ...
        <div class="card-body py-3">
          ...
          <div class="table-responsive">
            ...
            <th scope="row" class="min-w-100px text-end rounded-end">
            </th>
          @endif
                </tr>
              </thead>
          ...
          <tr id="data">
            ...
            <td>
            <a href="/dashboard/rooms/{{$room->code}}"
              class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{$room->name}}</a>
            </td>
            <td>
        ...
        <a href="/dashboard/rooms/{{ $room->code }}/edit"
          class="editroom btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" id="editroom"
          name="editroom" data-id="{{ $room->id }}" data-code="{{ $room->code }}" data-bs-toggle="modal"
        ...
        <form action="/dashboard/rooms/{{ $room->code }}" method="POST">
          ...
          onclick="return confirm('Delete room data?')">
