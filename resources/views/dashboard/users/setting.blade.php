...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div id="kt_content_container" class="container-xxl">
        ...
        @if(session()->has('passwordError'))
            <div class="col-md-16 mx-auto alert alert-danger text-center alert-success alert-dismissible fade show"
                style="margin-top: 50px" role="alert">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_profile_details" class="collapse show">
                <!--begin::Form-->
                <form method="post" action="{{ route('users.update') }}" id="kt_account_profile_details_form"
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="nomor_induk"
                                    ...
                                    value="{{ auth()->user()->nomor_induk }}" readonly>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                @elseif(auth()->user()->role_id == 3)
                                    <input type="text" name="role" class="form-control form-control-lg form-control-solid"
                                        value="DOSEN" readonly>
                                @elseif(auth()->user()->role_id == 4)
                                    <input type="text" name="role" class="form-control form-control-lg form-control-solid"
                                        value="KETUA KELAS" readonly>
                                @elseif(auth()->user()->role_id == 5)
                                    <input type="text" name="role" class="form-control form-control-lg form-control-solid"
                                        value="MAHASISWA" readonly>
                                @endif
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="password" name="old_password"
                                    class="form-control form-control-lg form-control-solid"
                                    placeholder="type old password here" required>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
